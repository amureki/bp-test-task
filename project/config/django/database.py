    ...
    def DATABASES(self):
        databases = {
            'default': {
                ...
                'NAME': u'bp-test-task',  # Or path to database file if using sqlite3.
                'USER': u'bp-test-task',  # Not used with sqlite3.
    ...
    def DATABASES(self):
        databases = {
            'default': {
                ...
                'HOST': 'bp-test-task-postgresql',  # Set to empty string for localhost. Not used with sqlite3.
                'PORT': 5432,  # Set to empty string for default. Not used with sqlite3.
            },
        }
        return databases
